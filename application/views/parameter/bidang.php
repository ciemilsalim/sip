...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="#" class="btn btn-primary mb-3 <?= $disabled ?>" data-toggle="modal" data-target="#bidangModal">Tambah Bidang</a>
                ...
                <tbody>
                    ...
                    if (isset($bidang)) 
                    {
                        ...
                        <tr>
                            ...
                            <td><?= $b['kd_bid_skpd']; ?></td>
                            <td><?= $b['nama_bidang']; ?></td>
                            <td><a href="#ubahbidangModal<?=$b['kd_bid_skpd']?>" data-toggle="modal" class="badge badge-success" style="<?= $class; ?>">Edit</a> </td>
                        </tr>
                        <?php endforeach; }?>
                </tbody>
