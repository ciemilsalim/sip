                    ...
                    <div class="row">
                        <div class="col-lg">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nip1" name="nip1"  value="<?= $kode1['nip'] ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nama1" name="nama1" value="<?= $kode1['nama'] ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="jabatan1" name="jabatan1" value="<?= $kode1['jabatan'] ?>">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nip2" name="nip2" value="<?= $kode2['nip'] ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nama2" name="nama2" value="<?= $kode2['nama'] ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="jabatan2" name="jabatan2" value="<?= $kode2['jabatan'] ?>">
                                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nip3" name="nip3" value="<?= $kode3['nip'] ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nama3" name="nama3" value="<?= $kode3['nama'] ?>">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="jabatan3" name="jabatan3" value="<?= $kode3['jabatan'] ?>">
                                </div>
