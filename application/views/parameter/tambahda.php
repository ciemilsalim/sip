       ...
       $("select").prop('required',true);
            ...
            <form action="<?= base_url('Parameter/da'); ?>" method="POST">
                ...
                ?>
                    <div class="form-group">
                       Kode Data Awal
                        <input name='kd_da' value="<?= $detil['kd_da']; ?>" class="form-control" readonly></input>
                    </div>
                    <div class="form-group">
                        <input name='sumber' value="<?= $detil['kd_sumber']; ?>" class="form-control" style="display:none"></input>
                        <input name='nmsumber' value="<?= $detil['nama_sumber']; ?>" class="form-control" readonly></input>
                    </div>
                <?php
                    }
                ?>
